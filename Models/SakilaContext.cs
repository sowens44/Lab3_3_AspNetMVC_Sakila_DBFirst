...
namespace Lab3_3_AspNetMVC_Sakila_DBFirst.Models
{
    public partial class SakilaContext : DbContext
    {
        ...
        public virtual DbSet<So2payment> So2payment { get; set; }
        public virtual DbSet<Sopayment> Sopayment { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<CustomerAuditLog>(entity =>
            {
                ...
                entity.Property(e => e.StoredId).HasColumnName("stored_id");

                entity.Property(e => e.StoredIdOld).HasColumnName("stored_id_old");
            ...
            modelBuilder.Entity<InvoiceAudit>(entity =>
            {
                entity.ToTable("Invoice_Audit");

                entity.Property(e => e.InvoiceAuditId).HasColumnName("Invoice_audit_id");
            ...
            modelBuilder.Entity<So2payment>(entity =>
            {
                entity.HasKey(e => e.PaymentId)
                    .ForSqlServerIsClustered(false);

                entity.ToTable("so2payment");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.So2payment)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_so2payment_customer");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.So2payment)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.SetNull)
                    .HasConstraintName("fk_so2payment_rental");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.So2payment)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_so2payment_staff");
            });

            modelBuilder.Entity<Sopayment>(entity =>
            {
                entity.HasKey(e => e.PaymentId)
                    .ForSqlServerIsClustered(false);

                entity.ToTable("sopayment");
                ...
                entity.HasOne(d => d.Customer)
                    .WithMany(p => p.Sopayment)
                    .HasForeignKey(d => d.CustomerId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_sopayment_customer");

                entity.HasOne(d => d.Rental)
                    .WithMany(p => p.Sopayment)
                    .HasForeignKey(d => d.RentalId)
                    .OnDelete(DeleteBehavior.SetNull)
                    .HasConstraintName("fk_sopayment_rental");

                entity.HasOne(d => d.Staff)
                    .WithMany(p => p.Sopayment)
                    .HasForeignKey(d => d.StaffId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("fk_sopayment_staff");
            });
